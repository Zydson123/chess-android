...
public class Piece {
    ...
    public static void move_piece(Piece piece, int posXofMove,int posYofMove, boolean whoseTurn, Piece board[][], boolean turn){
        if(piece.getColor()==whoseTurn) {
            if (board[posXofMove][posYofMove].check_legal(piece, board, posXofMove, posYofMove, turn)) {
                ...
                MainActivity.wasLegal = true;
                if(turn) MainActivity.turn = false;
                else MainActivity.turn = true;
    ...
    public boolean check_legal(Piece piece, Piece board[][],int posXofMove,int posYofMove, boolean turn){
        ...
        if(piece.getType()=='P' && piece.getColor()==true){
            ...
            //takes right
            else if(piece.getPosX()-posYofMove==1 && piece.getPosY()!=posXofMove && board[posYofMove][posXofMove].getType()!='l' && piece.getPosY()-posXofMove==-1 && posXofMove!=piece.getPosY() && board[posYofMove][posXofMove].getColor()!=piece.getColor()){
                isLegal = true;
            ...
            //takes
            else if(posYofMove-piece.getPosX()==1 && piece.getPosY()!=posXofMove && board[posYofMove][posXofMove].getType()!='l' && board[posYofMove][posXofMove].getColor()!=piece.getColor()){
                isLegal = true;;
            }
            else{
                isLegal=false;
